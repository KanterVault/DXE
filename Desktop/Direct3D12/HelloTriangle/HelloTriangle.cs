...
namespace HelloTriangle
{
    ...
    public class HelloTriangle : IDisposable
    {
        ...
        public void MouseEvent(object sender, MouseInputEventArgs e)
        {
            strInfo = e.X.ToString();
        }

        public void KeyboardEvent(object sender, KeyboardInputEventArgs e)
        {
        ...
        private void LoadPipeline(RenderForm form)
        {
            ...
            label = new Label() { Text = "Text", Location = new System.Drawing.Point(16, 16) };
